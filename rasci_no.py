...
for i in 1:norb - lumo_index
    ...
    h0 = npzread("../data/NO_h0_$(2*i).npy")
    h1 = npzread("../data/NO_h1_$(2*i).npy")
    h2 = npzread("../data/NO_h2_$(2*i).npy")
...
FileIO.save("../data/e_NO", "e", energies)
FileIO.save("../data/ex1_NO", "ex1", excitation_energy_i)
...
savefig("../data/NO_combined_plot.png")
